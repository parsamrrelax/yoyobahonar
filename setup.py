...
if defaultOutlineIP == '<SERVER-IP>':
    ...
    message = f"Ip ya hostname server ro bezan: (age khali bezari: `{defaultOutlineIP}`)\n"
...
outlinePort = input(f"Port morede estefadato bezan: (age khali bezari: `{defaultOutlinePort}`)\n")
if outlinePort == '':
